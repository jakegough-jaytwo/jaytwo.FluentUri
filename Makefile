TOPDIR=$(shell pwd)
BUILD_SLN=./jaytwo.FluentUri.sln
BUILD_DIR=./src/jaytwo.FluentUri
BUILD_TEST_DIR=./test/jaytwo.FluentUri.Tests
BUILD_TRX_FILENAME=jaytwo.FluentUri.Tests.trx
BUILD_PACKED_DIR=${TOPDIR}/out/packed
DOCKER_TAG?=jaytwo_fluenturi
